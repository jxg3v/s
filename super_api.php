...
$usernambot = $json_info['result']['username'];
...
$setnambot = file_get_contents("setname.txt");
$nambot = file_get_contents("nambot.txt");
...
√",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
if($text && $setnambot =="nam" and in_array($from_id,$Dev)){
file_put_contents("nambot.txt",$text); 
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>"اضفني الى مجموعتك ♣️",'url'=>"http://t.me/". bot('getme')->result->username. "?startgroup=new"]],
[['text'=>"مراسلة المطور 🚶",'url'=>"tg://openmessage?user_id=$admin"],['text'=>"لصنع بوتك",'url'=>"https://t.me/Meroo_0bot"]],
]])
]);
}} 
...
",
  'reply_to_message_id'=>$message_id,
    ...
    'inline_keyboard'=>[
 	[
['text'=>"🎉تابع جديدنا",'url'=>"https://t.me/AFTU2"],['text'=>"$dataadd",'callback_data'=>"text"]
	  ],
   ]
   ])
     ]); 
...
",
  'reply_to_message_id'=>$message_id,
    ...
    'inline_keyboard'=>[
	 	[
['text'=>"📢 تابع جديدنا 📢",'url'=>"https://t.me/AFTU2"]
	  ],
   ]
   ])
     ]); 
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت مجاني • √",'url'=>"https://telegram.me/Meroo_0bot?start"]
              ] 
              ],
        ])
            ]);
