...
error_reporting(0);
error_reporting(1);
$API_KEY = "7158601973:AAFMB_6svlRa1cvs0mW6nr3kvMfq-01vTkE";//توكنك#
...
'reply_markup'=>json_encode([ 
'inline_keyboard'=>[ 
[["text"=>"قائمة بوتاتك المصنوعه📠","callback_data"=>"delete"],["text"=>"انشاء بوت ⚙","callback_data"=>"make"]], 
]])
]);
}
if($data =="home"){
...
'chat_id'=>$chat_id2,
'message_id'=>$message_id2, 
'text'=>• انشاء بوت مجاني •:

1. اذهب  لى @BotFather وسوي بوت جديد. 
2. ستحصل على توكن مميز  (عيطلعلك مثل ، 12345 : 6789ABCDEF) - بس دزهَ او نسخه اليِ هناهٌ.", 
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[["text"=>"عودهَ","callback_data"=>"home"]],
]])
]);
}
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"✯‍︙تم صنعتلك بوت حمايهَ ",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[["text"=>"ادخلَ لبوتك وجربه فولّ",'url'=>"t.me/".$status_bot->result->username]],
[["text"=>"عودهَ","callback_data"=>"home"]],
]])
]);
...
[["text"=>"المطور","callback_data"=>"https://t.me/GJEGG"]],